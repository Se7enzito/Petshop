    ...
    $(document).ready(function(){
        ...
        $.fn.stickUp = function(options) {
            ...
            if(options != null) {
                ...
                itemHover = options.itemHover;
                if(options.topMargin != null) {
                    topMargin = isNaN(options.topMargin) ? 
                        options.topMargin === 'auto' ? parseInt($('.stuckMenu').css('margin-top')) :
                        parseInt(options.topMargin.replace('px', '')) : 
                        parseInt(options.topMargin);
                } else {
                    topMargin = 0;
                }
        ...
        $(document).on('scroll', function() {
            ...
            if(varscroll + topMargin >= $('.stuckMenu').offset()) {
                $('.wrapper').addClass('spHeight');
                $('.stuckMenu').addClass('isFixed');
                $('.stuckMenu').next().closest('div').css({
                    'margin-top': stickyHeight + stickyMarginB + currentMarginT + 'px'
